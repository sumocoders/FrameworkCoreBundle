...
`FrameworkCoreBundle` is a Symfony bundle providing shared scaffolding for SumoCoders projects: page titles,
breadcrumbs, menus, forms, file/image uploads, audit logging, pagination, and a frontend design system.

Install via the [application-skeleton](https://github.com/sumocoders/application-skeleton).
...
| [no-results.md](no-results.md)                     | Empty states: the no-results component for a page, a muted line inside a section       |
| [card-layouts.md](card-layouts.md)                 | Example card layouts: section cards, forms, overview with filter, item cards, detail page |
